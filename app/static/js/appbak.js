...
// let dataStates = [];
// d3.json("https://real-estate-mexico.herokuapp.com/vw_datos_estado").then(function(data){
...
function changedropMun() {
  ...
  d3.json("https://real-estate-mexico.herokuapp.com/vw_datos_municipio").then(function (data) {
    //console.log(data)
      ...
      let plotData2 = [
        {
          ...
          title: {
            text:
              "Avg built<br>surface price<br> per m2"
          },
          domain: { x: [0, 0.85], y: [0, 0.5] }
          //delta: { reference: 400, relative: true, position: "top" }
        },
        {
          ...
          title: {
            text:
            "Avg total<br>surface price<br> per m2" 
          },
          // delta: { relative: true },
          domain: { x: [0, 0.85], y: [0.5, 1] }
        }
